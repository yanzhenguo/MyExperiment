...
data_dir='../../temp/yahoo/extract_data/'
train_text=[]
train_label=[]
reader = csv.reader(open('/home/yan/my_datasets/yahoo_answers_csv/train.csv'))
for row in reader:
...
test_text=[]
test_label=[]
reader = csv.reader(open('/home/yan/my_datasets/yahoo_answers_csv/test.csv'))
for row in reader:
