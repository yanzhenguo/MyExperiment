...
data_dir='../../temp/amazon_p/extract_data/'
train_text=[]
train_label=[]
reader = csv.reader(open('/home/yan/my_datasets/amazon_review_polarity_csv/train.csv'))
for row in reader:
...
test_text=[]
test_label=[]
reader = csv.reader(open('/home/yan/my_datasets/amazon_review_polarity_csv/test.csv'))
for row in reader:
