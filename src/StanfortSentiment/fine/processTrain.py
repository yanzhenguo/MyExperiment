...
#保存结果
print('save')
f=codecs.open('D:\\docker\\StanfordSentiment\\FirstMethod\\train_sentence.pkl','wb')
pickle.dump(new_texts,f,1)
f.close()
np.save('D:\\docker\\StanfordSentiment\\FirstMethod\\Ytrain.npy',np.asarray(new_Y,dtype=np.int))
