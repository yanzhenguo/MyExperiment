...
from keras.layers import Dense, Dropout, Activation,Embedding,Convolution1D,MaxPooling1D,Merge
...
model2 = Sequential()
model2.add(Embedding(17838,embedding_dims,weights=[embedding_matric],input_length=maxlen,trainable=False))
...
basedir = '/media/yan/My Passport/StanfordSentiment/SecondMethod/'
...
model3.compile(optimizer='nadam',loss='categorical_crossentropy',metrics=['acc'])
