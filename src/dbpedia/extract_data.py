...
data_dir='../../temp/dbpedia/extract_data/'
train_text=[]
train_label=[]
reader = csv.reader(open('/home/yan/my_datasets/dbpedia_csv/train.csv'))
for row in reader:
...
test_text=[]
test_label=[]
reader = csv.reader(open('/home/yan/my_datasets/dbpedia_csv/test.csv'))
for row in reader:
