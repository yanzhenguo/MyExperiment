...
def get_input():
    ...
    x_seq= np.zeros((num_train+num_test, (max_len - 3) * 4), dtype=np.int)
...
def get_model(embedding_matrix):
    ...
    input_3=Input(((max_len - 3) * 4,))
    embedding_3 = Embedding(num_words*4, embedding_dimension)(input_3)
    z = AveragePooling1D(pool_size=4, strides=4, padding='valid')(embedding_3)
