...
# embedding2=Embedding(num_words,1000,input_length=max_len,embeddings_initializer='normal')(input)
# y=AveragePooling1D(pool_size=2,strides=1)(embedding2)
# y=GlobalMaxPooling1D()(y)

# embedding3=Embedding(num_words,1000,input_length=max_len,embeddings_initializer='normal')(input)
