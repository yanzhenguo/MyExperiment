...
def main(ngram):
    ...
    process_files(texts[0:12500], texts[12500:25000], dic, r, "train-nbsvm.txt", ngram)
    process_files(texts[25000:37500], texts[37500:50000], dic, r, "test-nbsvm.txt", ngram)
...
#2 91.652
#3 91.944
#train /home/yan/下载/liblinear-1.96/train -s 0 train-nbsvm.txt model
#test /home/yan/下载/liblinear-1.96/predict -b 1 test-nbsvm.txt model prediction
