...
y_train[0:12500]=np.ones((12500,),dtype=np.float32)
y_test[0:12500]=np.ones((12500,),dtype=np.float32)
...
if ngram_range > 1:
    ...
    # new_ngram_set=set()
    # for ng in ngram_set:
    #     if ng[0]!=0 and ng[1]!=0:
    #         new_ngram_set.add(ng)
    # ngram_set=new_ngram_set
