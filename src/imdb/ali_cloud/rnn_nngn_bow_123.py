...
def get_model(embedding_matrix):
    ...
    embedding_5 = Embedding(num_words, embedding_dimension)(input_1)
    q = AveragePooling1D(pool_size=3, strides=1, padding='valid')(embedding_5)
    q = GlobalMaxPooling1D()(q)

    a=keras.layers.concatenate([x,y,z,p,q])
